...
function ContactList({ history, onSelect }: Props) {
  if (history.length === 0)
    ...
    <ul className="divide-y p-2 space-y-2 divide-gray-200 bg-white rounded-lg overflow-hidden max-w-md mx-auto ">
      {history.map((contact) => (
        <li
          ...
          className="flex items-center rounded-lg  p-4 hover:bg-gray-50 shadow-md shadow-red-300/50 cursor-pointer transition bg-gray-200 hover:bg-gray-300"
